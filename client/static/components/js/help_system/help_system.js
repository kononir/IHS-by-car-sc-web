 ...
 * AutoHelp component.
 */
AutoHelp.DrawComponent = {
    ext_lang: 'auto_help_system',
    formats: ['format_auto_help_system_json'],
    struct_support: true,
    factory: function (sandbox) {
        return new AutoHelp.DrawWindow(sandbox);
    }
};

AutoHelp.DrawWindow = function (sandbox) {
    this.sandbox = sandbox;
    this.paintPanel = new AutoHelp.PaintPanel(this.sandbox.container);
...
SCWeb.core.ComponentManager.appendComponentInitialize(AutoHelp.DrawComponent);
