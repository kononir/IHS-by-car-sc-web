...
/**
 * AutopartSearcher component.
 */
AutopartSearcher.DrawComponent = {
    ext_lang: 'autopart_searching',
    formats: ['format_autopart_searching_json'],
    struct_support: true,
    factory: function (sandbox) {
        return new AutopartSearcher.DrawWindow(sandbox);
    }
};

AutopartSearcher.DrawWindow = function (sandbox) {
    this.sandbox = sandbox;
    this.paintPanel = new AutopartSearcher.PaintPanel(this.sandbox.container);
...
SCWeb.core.ComponentManager.appendComponentInitialize(AutopartSearcher.DrawComponent);
/**
 * Paint panel.
 */
