...
Example.PaintPanel.prototype = {
    ...
    _initMarkup: function (containerId) {
        ...
        container.append('<p><button id="newButton" type="button">Узнать все о главном меню</button></p>');
        container.append('<p><button id="searchInfoButton" type="button">Поиск главного идентификатора</button></p>');
        container.append('<p><button id="moveToNavigationNode" type="button">Перейти к описанию ключевых узлов навигации</button></p>');
        //If you don't want to make default command - add class="sc-no-default-cmd" to button
        container.append('<p><button id="generateNodes" type="button">Генерация узлов</button></p>');
